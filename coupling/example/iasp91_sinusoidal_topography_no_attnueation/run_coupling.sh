#!/bin/bash
#
dir_SEM=../../../specfem3d/EXAMPLES_COUPLING/iasp91_sinusoidal_topography_no_attenuation
#dir_SEM=../../../specfem3d/EXAMPLES_COUPLING/iasp91_sinusoidal_topography
dir_DSM=../../../DSM/example/iasp91_sinusoidal_topography_no_attenuation
...
echo
echo
echo "Waiting for job done! It takes a few minutes."
echo
