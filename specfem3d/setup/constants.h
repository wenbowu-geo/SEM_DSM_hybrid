...
double precision, parameter :: R_TOP_BOUND=6371000.0
!For 660km
!double precision, parameter :: R_TOP_BOUND=5705000.0

!icb or outer core coupling
!double precision, parameter :: R_TOP_BOUND=1267100.0
!inner core coupling
!double precision, parameter :: R_TOP_BOUND=1207100.0


! the minimum depth and distance interval (meter) we allow for DSM coupling
!The tolerence value depends on the grid resolution and topography.
!Small region or High resolution
  double precision,parameter ::depth_tolerence =50.0
!Large region or Low resolution
!   double precision,parameter ::depth_tolerence =200.0

!  double precision,parameter ::dist_tolerence  =0.01
  double precision,parameter ::dist_tolerence  =0.00001
!  double precision,parameter ::dist_tolerence  =0.01
!double precision,parameter ::dist_tolerence  =0.000449
  integer, parameter ::MAX_NDEPTH_TABLE=1000
