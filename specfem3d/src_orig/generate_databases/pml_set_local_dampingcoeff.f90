...
subroutine pml_set_local_dampingcoeff(myrank,xstore,ystore,zstore)
  ...
  real(kind=4) :: pml_damping_profile_l
...
!  real(kind=4)::dist
  ...
  real(kind=CUSTOM_REAL) :: k_x,k_y,k_z,alpha_x,alpha_y,alpha_z,beta_x,beta_y,beta_z
  real(kind=4) :: d_x,d_y,d_z
!  real(kind=CUSTOM_REAL) :: d_x,d_y,d_z
