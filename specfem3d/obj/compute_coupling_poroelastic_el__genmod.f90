        ...
        MODULE COMPUTE_COUPLING_POROELASTIC_EL__genmod
          INTERFACE 
            SUBROUTINE COMPUTE_COUPLING_POROELASTIC_EL(NSPEC_AB,NGLOB_AB&
     &,IBOOL,DISPLS_POROELASTIC,ACCELS_POROELASTIC,DISPLW_POROELASTIC,  &
     &XIX,XIY,XIZ,ETAX,ETAY,ETAZ,GAMMAX,GAMMAY,GAMMAZ,HPRIME_XX,        &
     &HPRIME_YY,HPRIME_ZZ,KAPPAARRAYSTORE,RHOARRAYSTORE,MUSTORE,PHISTORE&
     &,TORTSTORE,JACOBIAN,DISPL,KAPPASTORE,ANISOTROPY,NSPEC_ANISO,      &
     &C11STORE,C12STORE,C13STORE,C14STORE,C15STORE,C16STORE,C22STORE,   &
     &C23STORE,C24STORE,C25STORE,C26STORE,C33STORE,C34STORE,C35STORE,   &
     &C36STORE,C44STORE,C45STORE,C46STORE,C55STORE,C56STORE,C66STORE,   &
     &SIMULATION_TYPE,NGLOB_ADJOINT,NSPEC_ADJOINT,                      &
     &NUM_COUPLING_EL_PO_FACES,COUPLING_EL_PO_ISPEC,COUPLING_PO_EL_ISPEC&
     &,COUPLING_EL_PO_IJK,COUPLING_PO_EL_IJK,COUPLING_EL_PO_NORMAL,     &
     ...
     &NUM_COUPLING_EL_PO_FACES)
          ...
          END INTERFACE 
        END MODULE COMPUTE_COUPLING_POROELASTIC_EL__genmod
