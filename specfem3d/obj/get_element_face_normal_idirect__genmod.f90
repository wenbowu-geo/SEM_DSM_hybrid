        ...
        MODULE GET_ELEMENT_FACE_NORMAL_IDIRECT__genmod
          INTERFACE 
            SUBROUTINE GET_ELEMENT_FACE_NORMAL_IDIRECT(ISPEC,IFACE,     &
     &XCOORD,YCOORD,ZCOORD,IBOOL,NSPEC,NGLOB,XSTORE_DUMMY,YSTORE_DUMMY, &
     &ZSTORE_DUMMY,NORMAL,IDIRECT)
              ...
              INTEGER(KIND=4), INTENT(OUT) :: IDIRECT
            END SUBROUTINE GET_ELEMENT_FACE_NORMAL_IDIRECT
          END INTERFACE 
        END MODULE GET_ELEMENT_FACE_NORMAL_IDIRECT__genmod
