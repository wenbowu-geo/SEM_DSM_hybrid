        ...
        MODULE WRITE_VTK_DATA_GLL_I__genmod
          INTERFACE 
            SUBROUTINE WRITE_VTK_DATA_GLL_I(NSPEC,NGLOB,XSTORE_DUMMY,   &
     &YSTORE_DUMMY,ZSTORE_DUMMY,IBOOL,GLL_DATA,PRNAME_FILE)
              ...
              INTEGER(KIND=4) :: GLL_DATA(5,5,5,NSPEC)
              CHARACTER(LEN=512) :: PRNAME_FILE
            END SUBROUTINE WRITE_VTK_DATA_GLL_I
          END INTERFACE 
        END MODULE WRITE_VTK_DATA_GLL_I__genmod
