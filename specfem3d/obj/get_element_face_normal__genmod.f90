        ...
        MODULE GET_ELEMENT_FACE_NORMAL__genmod
          INTERFACE 
            SUBROUTINE GET_ELEMENT_FACE_NORMAL(ISPEC,IFACE,XCOORD,YCOORD&
     &,ZCOORD,IBOOL,NSPEC,NGLOB,XSTORE_DUMMY,YSTORE_DUMMY,ZSTORE_DUMMY, &
     &NORMAL)
          ...
          END INTERFACE 
        END MODULE GET_ELEMENT_FACE_NORMAL__genmod
