        ...
        MODULE CVD_WRITE_CORNERS__genmod
          INTERFACE 
            SUBROUTINE CVD_WRITE_CORNERS(NSPEC_AB,NGLOB_AB,IBOOL,XSTORE,&
     &YSTORE,ZSTORE,DAT,IT,NPP,NUMPOIN,NP)
          ...
          END INTERFACE 
        END MODULE CVD_WRITE_CORNERS__genmod
