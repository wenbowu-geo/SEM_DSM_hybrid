        ...
        MODULE SAVE_DATABASES_ADIOS__genmod
          INTERFACE 
            SUBROUTINE SAVE_DATABASES_ADIOS(LOCAL_PATH,MYRANK,SIZEPROCS,&
     &NSPEC,NGLOB,IPROC_XI,IPROC_ETA,NPROC_XI,NPROC_ETA,ADDRESSING,     &
     &IMPICUT_XI,IMPICUT_ETA,IBOOL,NODES_COORDS,ISPEC_MATERIAL_ID,      &
     &NSPEC2D_XMIN,NSPEC2D_XMAX,NSPEC2D_YMIN,NSPEC2D_YMAX,NSPEC2D_BOTTOM&
     &,NSPEC2D_TOP,NSPEC2DMAX_XMIN_XMAX,NSPEC2DMAX_YMIN_YMAX,IBELM_XMIN,&
     &IBELM_XMAX,IBELM_YMIN,IBELM_YMAX,IBELM_BOTTOM,IBELM_TOP,NMATERIALS&
     &,MATERIAL_PROPERTIES,NSPEC_CPML,CPML_TO_SPEC,CPML_REGIONS,IS_CPML)
          ...
          END INTERFACE 
        END MODULE SAVE_DATABASES_ADIOS__genmod
