        ...
        MODULE GET_TOPO_ELEVATION_FREE_CLOSEST__genmod
          INTERFACE 
            SUBROUTINE GET_TOPO_ELEVATION_FREE_CLOSEST(X_TARGET,Y_TARGET&
     ...
     &NUM_FREE_SURFACE_FACES)
          ...
          END INTERFACE 
        END MODULE GET_TOPO_ELEVATION_FREE_CLOSEST__genmod
