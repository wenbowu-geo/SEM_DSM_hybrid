        ...
        MODULE CVD_WRITE_GLL_ELEMENTS__genmod
          INTERFACE 
            SUBROUTINE CVD_WRITE_GLL_ELEMENTS(NSPEC_AB,NGLOB_AB,IBOOL,NP&
     &,NELEMENT,IT,NEE,NUMPOIN)
          ...
          END INTERFACE 
        END MODULE CVD_WRITE_GLL_ELEMENTS__genmod
