        ...
        MODULE COMPUTE_FORCES_ACOUSTIC_NGLL5_FAST__genmod
          INTERFACE 
            SUBROUTINE COMPUTE_FORCES_ACOUSTIC_NGLL5_FAST(IPHASE,       &
     &NSPEC_AB,NGLOB_AB,POTENTIAL_ACOUSTIC,POTENTIAL_DOT_ACOUSTIC,      &
     ...
     &NUM_PHASE_ISPEC_ACOUSTIC,2)
          ...
          END INTERFACE 
        END MODULE COMPUTE_FORCES_ACOUSTIC_NGLL5_FAST__genmod
