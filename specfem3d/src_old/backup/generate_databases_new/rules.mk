...
S := ${S_TOP}/src_DSMcoupling_nostretch/generate_databases
$(generate_databases_OBJECTS): S = ${S_TOP}/src_DSMcoupling_nostretch/generate_databases
...
generate_databases_OBJECTS = \
	...
	$O/save_depth_id_innerbound.gen.o \
	$O/read_EleBound.gen.o \
	$O/get_Telecoupling_info.gen.o \
	$O/set_Variables_Bound.gen.o \
	$O/read_TelePara.gen.o \
	$O/xyz_backto_cubedsph.gen.o \
	$O/euler_angles_back_cubedsph.gen.o \
	$O/SEMtoTele_par.gen.o \
	$O/SEMtoTeleseis.gen.o \
...
#WENBO_S
$O/save_package_list.gen.o: $O/SEMtoTele_par.gen.o
$O/save_depth_id.gen.o: $O/model_tomography.gen.o
$O/save_depth_id_innerbound.gen.o: $O/model_tomography.gen.o $O/SEMtoTele_par.gen.o
$O/get_Telecoupling_info.gen.o: $O/SEMtoTele_par.gen.o $O/generate_databases_par.gen.o
$O/set_Variables_Bound.gen.o: $O/SEMtoTele_par.gen.o
#$O/save_package_list.gen.o: $O/SEMtoTele_par.gen.o
$O/read_EleBound.gen.o: $O/SEMtoTele_par.gen.o
$O/read_TelePara.gen.o : $O/SEMtoTele_par.gen.o
$O/SEMtoTeleseis.gen.o: $O/SEMtoTele_par.gen.o
#WENBO_E
