...
!WENBO
  print *,'coordinates_ready',myrank,iinterface,nibool_interfaces_ext_mesh(iinterface)
...
!WENBO
!  if(nibool_interfaces_ext_mesh(iinterface).gt.0)&
...
!WENBO
  print *,'cleanup_arrays',iinterface
  call synchronize_all()
...
!WENBO
    write(IMAIN,*) '     total assembled MPI interface points:',inum,iglob,ilocnum
