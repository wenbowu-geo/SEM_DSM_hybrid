...
c
c     USAGE:ydist dlons dlats dlonr dlonr
c     OUTPUT: gcarc backazimuth azimuth
*----------------------------------------------------------------------*------*
c     PARAMETERS
c
      real*8    dlats, dlons, dlatr, dlonr, delta, cazim, bazim
c
...
c      CALL getArg(1,temp)
c      read(temp,*)dlons
c      CALL getArg(2,temp)
c      read(temp,*)dlats
c      CALL getArg(3,temp)
c      read(temp,*)dlonr
c      CALL getArg(4,temp)
c      read(temp,*)dlatr
