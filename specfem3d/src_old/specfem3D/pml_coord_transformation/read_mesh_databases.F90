...
!WENBO_S
        do ispec=1,NSPEC_CPML
           if(CPML_regions(ispec)==CPML_X_ONLY) then
             CPML_regions(ispec)=CPML_Y_ONLY
           else if(CPML_regions(ispec)==CPML_Y_ONLY) then
             CPML_regions(ispec)=CPML_Z_ONLY
           else if(CPML_regions(ispec)==CPML_Z_ONLY) then
             CPML_regions(ispec)=CPML_X_ONLY
           else if(CPML_regions(ispec)==CPML_XY_ONLY) then
             CPML_regions(ispec)=CPML_YZ_ONLY
           else if(CPML_regions(ispec)==CPML_XZ_ONLY) then
             CPML_regions(ispec)=CPML_XY_ONLY
           else if(CPML_regions(ispec)==CPML_YZ_ONLY) then
             CPML_regions(ispec)=CPML_XZ_ONLY
           end if
        end do
!WENBO_E
