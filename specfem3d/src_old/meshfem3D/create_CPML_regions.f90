...
!=====================================================================
  ...
  do ispec = 1,nspec
!WENBO debug
!if(myrank.eq.0.and.ispec.eq.867) &
!   print *,'xyz_thisispec',nodes_coords(ibool(2,2,1,ispec),:),xmin_all,xmax_all,&
!        zmin_all,zmax_all
...
!WENBO debug
!        if(myrank.eq.0.and.ispec.eq.867) &
!           print *,'xyz_thisispec_error',nodes_coords(ibool(1,1,1,ispec),:),&
!                xmin_all
    endif
...
!WENBO
!    if(nodes_coords(i1,3)<-40000.0) &
!    print *,'bottom_abs',nodes_coords(i1,3),nodes_coords(i2,3),nodes_coords(i3,3),&
!        nodes_coords(i4,3),nodes_coords(i5,3),nodes_coords(i6,3),nodes_coords(i7,3),&
!        nodes_coords(i8,3),zmin_all+THICKNESS_OF_Z_PML
