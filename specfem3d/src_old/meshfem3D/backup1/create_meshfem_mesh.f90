...
!WENBO_S
  use SEMtoTele_MeshPar, only: nx_TopoTaper,ny_TopoTaper,nx_notopo,ny_notopo,&
   TeleEle_nxLow,TeleEle_nxHigh,TeleEle_nyLow,TeleEle_nyHigh,TeleEle_nrTop,TeleEle_nrBot,&
   TeleEle_xLow,TeleEle_xLowReg,TeleEle_xHigh,TeleEle_xHighReg,&
   TeleEle_yLow,TeleEle_yLowReg,TeleEle_yHigh,TeleEle_yHighReg,&
   TeleEle_rTop,TeleEle_rTopReg,TeleEle_rBot,TeleEle_rBotReg,Imain_SEMtoTele,&
   rotation_matrix,ANGULAR_WIDTH_XI_IN_DEGREES,ANGULAR_WIDTH_ETA_IN_DEGREES,&
   TELE_IXLOW,TELE_IXHIGH,TELE_IYLOW,TELE_IYHIGH,TELE_IRTOP,TELE_IRBOT,&
   xstore_cubedsph,ystore_cubedsph,zstore_cubedsph,nodes_coords_cubedsph,&
   nodes_coords_cubedsph_old
!WENBO_E

!   Tele_ixLow,Tele_ixHigh,Tele_iyLow,Tele_iyHigh,Tele_irTop,Tele_irBot,&
!   TeleEle_ixLow,TeleEle_ixHigh,TeleEle_iyLow,TeleEle_iyHigh,TeleEle_irTop,TeleEle_irBot
...
!WENBO_S
    TeleEle_ixLow=0;TeleEle_ixHigh=0;TeleEle_iyLow=0;TeleEle_iyHigh=0;TeleEle_irTop=0;TeleEle_irBot=0
!WENBO_E
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                !Redefine media type, because the coupling elements at
                !the same depth might have different media types. e.g.,
                !the left side is ocean while the right side is land
                !(like South America).
                !Alghouth the coupling theory requires the boundary
                !structure to match the dsm structure, the reality
                !might be not the case.

!               xelm,yelm and zelm should be cubed sphere coordinates,
!               therefore we need to run it before calling the subroutine cubed_sphere.
                if(isubregion.eq.1) then
!South America - ocean
!to be fixed
!                  call redefine_ocean_land(xelm,yelm,zelm,imaterial_number,&
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                ...
                call cubed_geo(xelm,yelm,zelm,ANGULAR_WIDTH_XI_IN_DEGREES,&
                       ANGULAR_WIDTH_ETA_IN_DEGREES,rotation_matrix)
                  ! store coordinates
                call store_coords(xstore,ystore,zstore,xelm,yelm,zelm,ispec,nspec)
                call getEle_TeleBound(Tele_ixLow,Tele_ixHigh,Tele_iyLow, &
...
!               xelm,yelm and zelm should be cubed sphere coordinates,
!               therefore we need to run it before calling the subroutine
!               cubed_sphere.
                   if(isubregion.eq.1) then
!to be fixed
!South America - ocean
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                    ...
                    call store_coords(xstore,ystore,zstore,xelm,yelm,zelm,ispec,nspec)
                    call getEle_TeleBound(Tele_ixLow,Tele_ixHigh,Tele_iyLow,&
                           Tele_iyHigh,Tele_irTop,Tele_irBot,TeleEle_nxLow,&
                           TeleEle_ixLow,TeleEle_xLow,TeleEle_xLowReg,&
                           TeleEle_nxHigh,TeleEle_ixHigh,TeleEle_xHigh,TeleEle_xHighReg,TeleEle_nyLow,&
                           TeleEle_iyLow,TeleEle_yLow,TeleEle_yLowReg,TeleEle_nyHigh,TeleEle_iyHigh,TeleEle_yHigh,&
                           TeleEle_yHighReg,TeleEle_nrTop,TeleEle_irTop,TeleEle_rTop,TeleEle_rTopReg,&
                           TeleEle_nrBot,TeleEle_irBot,TeleEle_rBot,TeleEle_rBotReg,ixele,&
...
!WENBO_S
  if(TeleEle_ixLow.ne.TeleEle_nxLow.or.TeleEle_ixHigh.ne.TeleEle_nxHigh.or.TeleEle_iyLow.ne.TeleEle_nyLow &
       .or.TeleEle_iyHigh.ne.TeleEle_nyHigh.or.TeleEle_irTop.ne.TeleEle_nrTop.or.TeleEle_irBot.ne.TeleEle_nrBot) then
         print *,'TeleEle',TeleEle_ixLow,TeleEle_nxLow,TeleEle_ixHigh,TeleEle_nxHigh,TeleEle_iyLow,TeleEle_nyLow &
                ,TeleEle_iyHigh,TeleEle_nyHigh,TeleEle_irTop,TeleEle_irBot,TeleEle_nrTop,TeleEle_nrBot,&
                'nrele',Tele_ixLow,Tele_ixHigh,Tele_iyLow,Tele_iyHigh,Tele_irTop,Tele_irBot,myrank
         call exit_MPI(myrank,'TeleEle_i(x,y,r) should equal TeleEle_n(x,y,r)')
  end if
!WENBO_E
  ...
  if(CUBED_SPHERE_PROJECTION) then
      if(myrank.eq.0)   write (Imain_SEMtoTele,*) 'save the boundary elements information'
      call save_SEMtoTeleEle(TeleEle_nxLow,TeleEle_xLow,TeleEle_xLowReg,TeleEle_nxHigh,TeleEle_xHigh,&
                ...
                TeleEle_nrBot,TeleEle_rBot,TeleEle_rBotReg,LOCAL_PATH,myrank)

      if(myrank.eq.0)  close(Imain_SEMtoTele)
  end if
