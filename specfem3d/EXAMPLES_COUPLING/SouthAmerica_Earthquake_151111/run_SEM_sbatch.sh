...
echo "running SouhtAmerica_Earthquake_151111 example: `date`"
currentdir=`pwd`
mpiruncmd="mpirun"
...
NNODE=`echo "$NPROC" | awk '{print int($1/40);}'`
...
#Meshing
                ...
                echo "#PBS -l nodes=${NNODE}:ppn=40,walltime=00:20:00" >> run_meshfem3D.pbs
...
#Generating database
                ...
                echo "#PBS -l nodes=${NNODE}:ppn=40,walltime=00:30:00" >> run_generate_databases.pbs
...
#Runing solver
                ...
                echo "#PBS -l nodes=${NNODE}:ppn=40,walltime=18:00:00" >> run_specfem3d.pbs
...
jobid_gen_tmp=$(sbatch --dependency=afterany:$jobid_mesh run_generate_databases.pbs)
...
jobid_spec=`sbatch --dependency=afterany:${jobid_gen} run_specfem3d.pbs`
