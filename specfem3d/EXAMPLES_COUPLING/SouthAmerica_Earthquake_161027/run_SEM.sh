...
#However, topography is not truncated and tapered. xmeshfem3D will read this 
#file and determine each elements as fluid (ocean) or solid media type.
../../bin/xcubedsphere_topo_FindOcean ./DATA/meshfem3D_files/SA_real_topo.dat 540 540 -0.2        -0.2      0.01    0.01
