...
!  if(fluid_thispoint.ne.fluid_thiszone(izone1_Radi)) then
!           print *,"izone1",izone1_Radi
!           print *,"fluid_thiszone",fluid_thiszone(izone1_Radi),fluid_thispoint
!  end if
...
!Trench sediment
              if(fluid_thispoint.eq.0.and.dist_min.le.0.224) then
                  ...
                  sediment_units=1
              else if(fluid_thispoint.eq.0.and.dist_min.ge.0.224.and.topo.lt.-500) then
!Sediemnt on shelft
...
!                    if(sedi_thick_thispoint>13000.0) print *,'check_sedi_thickness',dist_min,sedi_thick_thispoint
...
!                   if(sedi_thick_thispoint>13000.0.and.dist_Ocbot>10000.0) print *,'check_sedi_thickness',dist_min,&
