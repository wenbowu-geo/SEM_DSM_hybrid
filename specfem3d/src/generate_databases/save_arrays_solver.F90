...
!  if (SAVE_MESH_FILES.and.myrank.ge.127.and.myrank.le.143) call save_arrays_solver_files(nspec,nglob,ibool)
!  if (SAVE_MESH_FILES.and.myrank.ge.16.and.myrank.le.31) call save_arrays_solver_files(nspec,nglob,ibool)
!WENBO_E
#ifdef DEBUG_COUPLED
