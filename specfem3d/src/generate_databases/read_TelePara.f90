...
! call read_value_double_precision_tele(IIN,IGNORE_JUNK,THICKNESS_BLOCK_KM,'SEMtoTele.THICKNESS_BLOCK_KM',ier)
! if(ier /= 0) stop 'Error reading SEMtoTele paramete THICKNESS_BLOCK_KM'
