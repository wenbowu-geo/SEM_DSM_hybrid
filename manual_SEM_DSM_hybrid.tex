...
\title{\textbf{SEM-DSM hybrid method}\\
 \textbf{User Manual}}

\author {Wenbo Wu$^{1,2}$, Sidao Ni$^1$, Zhongwen Zhan$^3$, Shengji Wei$^4$ \\
  $^{1}$State Key Laboratory of Geodesy and Earth's Dynamics, Institute of Geodesy and Geophysics,  \\
  Chinese Academy of Sciences. Email: shaguan@gmail.com \\
  $^2$ Department of Geosciences, Princeton
    University. \\    
...
%\author{\copyright State Key Laboratory of Geodesy and Earth's Dynamics, \\ Institute of Geodesy and Geophysics,\\
